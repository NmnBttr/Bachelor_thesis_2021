...
#
#  snakemake -s fastSTRUCTURE_chrX.Snakefile -j 50 -k --cluster "sbatch -p nowick -J X_fStr -D /data/scratch/bajiv90/admixture_Namuun/hgdp/Xchr -o %x.%j.out -t 15-00:00:00 -c 12 --mem-per-cpu=15000"
#
#
#  07/07/2021
#  Vladimir Bajic
...
FILENAME = "HGDP_0sexRem_YMTRem_MindGeno_pruned_Xchr"
